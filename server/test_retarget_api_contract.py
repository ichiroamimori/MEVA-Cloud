...
EXPECTED_ROUTES = {
    ...
    ("POST", "/api/retarget/configs/publish-workspace"),
    ("POST", "/api/retarget/configs/archive"),
    ("POST", "/api/retarget/configs/replace-standard"),
    ...
    ("GET", "/api/retarget/compute-backend"),
    ("GET", "/api/retarget/main/file"),
    ("GET", "/api/retarget/job/{job_id}"),
    ("POST", "/api/retarget/job/{job_id}/cancel"),
